			...
			<form id="quiz_form" action="<?php the_permalink(); ?>" method="POST">				
				...
				<div class="quiz-question">
					<div class="question-title">
						...
						<h4 class="nomargin"><?php echo htmlentities(themex_stripslashes($question['question'])); ?></h4>
					</div>				
					<ul>
						<?php
						...
						foreach($question['answers'] as $answer_key=>$answer) {
							...
							<li class="<?php echo ThemexCourse::checkQuestion($question, 'answer_'.$question_key.'_'.$answer_key); ?>">
								...
								<label for="answer_<?php echo $question_key.'_'.$answer_key; ?>"><?php echo htmlentities(themex_stripslashes($answer)); ?></label>
							</li>
							<?php 
							}
						} 
