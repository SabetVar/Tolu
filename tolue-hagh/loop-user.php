...
<div class="expert-preview">
	...
	<div class="expert-text">
		<h4 class="nomargin">
			...
			<?php echo ThemexUser::getFulllastName(ThemexUser::$data['current_user']); ?>
			</a>
		</h4>
		<span class="expert-signature"><?php echo ThemexUser::$data['current_user']->signature; ?></span>
        
		<?php
		 echo ThemexUser::getDescription(ThemexUser::$data['current_user']->description, 400 , '<a class="button read-d" href="'.get_author_posts_url(ThemexUser::$data['current_user']->ID).'">  ادامه </a>' ); ?>
	</div>
</div>