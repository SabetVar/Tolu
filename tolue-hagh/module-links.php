...
<?php if(ThemexUser::$data['current_user']->twitter) { ?><a href="<?php echo ThemexUser::$data['current_user']->twitter; ?>" class="twitter" target="_blank" title="توئیتر <?php echo ThemexUser::getFullName(ThemexUser::$data['current_user']); ?> "></a><?php } ?>
...
<?php if(ThemexUser::$data['current_user']->telegram) { ?><a href="<?php echo ThemexUser::$data['current_user']->telegram; ?>" class="telegram" target="_blank" title="telegram"></a><?php } ?>
<?php if(ThemexUser::$data['current_user']->instagram) { ?><a title=" اینستاگرام <?php echo ThemexUser::getFullName(ThemexUser::$data['current_user']); ?>" href="<?php echo ThemexUser::$data['current_user']->instagram; ?>" class="instagram" target="_blank" ></a><?php } ?>
...
<?php if(ThemexUser::$data['current_user']->youtube) { ?><a href="<?php echo ThemexUser::$data['current_user']->youtube; ?>" class="rss" target="_blank" title="وب سایت/وب لاگ"></a><?php } ?>
