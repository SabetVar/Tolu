...
*/
	...
	public static function addUser($ID=0, $user=null) {
		...
		else {$arrvalue = http_build_query($userarray);}
...
//Render statistics page
	...
	public static function getClassNumber($courseID) {
		...
		if ($classnumbermeta && $classnumbermeta !=0) { $classnumber = $classnumbermeta; }
		...
		if ($showpresent){
			 ...
			 $out = '<ul class="present_list"> <div class="present_title"> حضور و غیاب شما در کلاس : </div>';
			  ...
			  while($classzero <= $classnumber) {
				 ...
				 if (in_array( $classzero, $userpresents)) { $checked ='class = "checked" ';}
