...
<div class="eightcol column">
    ...
    <div class="regbox regpage">

        <h1 class="reghead"><?php _e('Register','academy'); ?></h1>

        <p> با تکمیل فرم ذیل میتوانید در سایت موسسه طلوع عضو شوید. <a href="http://toluehagh.ir/?p=2703" target="_blank">راهنما؟</a></p>
            ...
            <form class="register-form" action="<?php echo AJAX_URL; ?>" method="POST">
                ...
                <div class="sixcol column last">
                  ...
                  <div class="field-wrapper">
                        ...
                        <input class="text-left" type="text" name="user_email" placeholder="<?php _e('Email','academy'); ?>" />
                ...
                <div class="sixcol column last">
                    ...
                    <div class="field-wrapper">
                        ...
                        <input class="text-left" type="password" name="user_password_repeat" placeholder="<?php _e('Repeat Password','academy'); ?>" />
                ...
                <div class="sixcol column last">
                    ...
                    <div class="form-captcha">
                        ...
                        <input class="text-left" type="text" name="captcha" id="captcha" size="6" value="" />
...
<div class="fourcol column last">
    ...
    <div class="regbox regpage">
        ...
        <h1 class="reghead"><?php _e('Sign In','academy'); ?></h1>

        <p>در صورتی که در سایت عضو شده اید، با وارد کردن نام کاربری و رمز عبور خود در فرم ذیل وارد سایت شوید.</p>

          <?php  if ( class_exists( 'WooCommerce' ) ) {
                          $losturl = wc_lostpassword_url(); 
                        } else {$losturl = wp_lostpassword_url();

                    };

          ?>

        <p><a href="<?php echo $losturl ;?>"> نام کاربری یا رمز خود را فرآموش کرده اید؟!</a></p>
