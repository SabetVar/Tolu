...
<div class="course-preview <?php echo ThemexCourse::$data['course']['status']; ?>-course">
	...
	<div class="course-meta">
		...
		<header class="course-header">
			...
			<a href="<?php echo ThemexCourse::$data['course']['author']->user_link; ?>" class="ci author nicon" title=" نمایش صفحه استاد <?php echo ThemexCourse::$data['course']['author']->full_name; ?>"> استاد : <?php echo ThemexCourse::$data['course']['author']->full_name; ?></a>
